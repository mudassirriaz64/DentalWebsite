            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  className="col-span-3 flex flex-col cursor-pointer hover:underline"
                >
                ...
                <div className="col-span-1 text-right flex justify-end gap-1.5">
                  <button
                    onClick={() => handleOpenDetail(sub)}
                    className="p-1.5 text-slate-400 hover:text-primary hover:bg-slate-100 rounded cursor-pointer"
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-accent hover:bg-slate-100 rounded cursor-pointer"
                    title="Delete record"
                  >
