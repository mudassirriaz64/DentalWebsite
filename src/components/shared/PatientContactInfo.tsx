...
const WhatsAppIcon: React.FC = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-green-500 hover:fill-green-600 transition-colors">
        ...
        <div className="flex gap-3 mt-1.5 items-center select-none" onClick={(e) => e.stopPropagation()}>
          {phone && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[10px] font-bold text-primary hover:text-[#000000] transition-colors"
              title={`Call ${name}`}
            >
          ...
          {whatsapp && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[10px] font-bold text-green-600 hover:text-green-700 transition-colors"
